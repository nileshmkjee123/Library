     ...
     useEffect( () =>{
        const fetchUserHistory= async () => {
            if(authState && authState.isAuthenticated){
                const url = `${process.env.REACT_APP_API}/histories/search/findBooksByUserEmail?userEmail=${authState.accessToken?.claims.sub}&page=${currentPage
            -1}&size=5`;
                ...
                <div className="row g-0">
                    ...
                    <div className="col">
                        <div className="card-body">
                            <h5 className="card-tile">{history.author}</h5>
                            <h4>{history.title}</h4>
